...
Generated from: https://api.apis.guru/v2/specs/azure.com/sql-dataWarehouseUserActivities/2017-03-01-preview/swagger.json<br/>
...
* `dataWarehouseUserActivityName` - _required_ - The activity name of the data warehouse. 
...
**flow**ground :- Telekom iPaaS / azure-com-sql-data-warehouse-user-activities-connector<br/>
